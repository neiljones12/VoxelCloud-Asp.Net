...
(function (global, factory) {
     ...
     * expecting.
     *
     * The invariant message will be stripped in Deviceion, but the invariant
     * will remain to ensure logic does not differ in Deviceion.
     */
...

    {
        ...
        // functions in invokeGuardedCallback, and the Deviceion version of
            ...
            var invokeGuardedCallbackDev = function (name, func, context, a, b, c, d, e, f) {
                ...
                if (didError) {
                    if (!didSetError) {
                        ...
                        error = new Error('An error was thrown inside one of your components, but React ' + "doesn't know what it was. This is likely due to browser " + 'flakiness. React does its best to preserve the "Pause on ' + 'exceptions" behavior of the DevTools, which requires some ' + "DEV-mode only tricks. It's possible that these don't work in " + 'your browser. Try triggering the error in Deviceion mode, ' + 'or switching to a modern browser. If you suspect that this is ' + 'actually an issue with React, please file an issue.');
    ...
    var ReactErrorUtils = {
         ...
         *
         * In Deviceion, this is implemented using a try-catch. The reason we don't
     ...
     * paths. Removing the logging code for Deviceion environments will keep the
    ...
    // And it can be bad for performance in Deviceion.
    ...
    function computeInteractiveExpiration(currentTime) {
        ...
        // dev than in Deviceion.
        // If the main thread is being blocked so long that you hit the expiration,
        // it's a problem that could be solved with better scheduling.
        // People will be more likely to notice this and fix it with the long
        // expiration time in development.
        // In Deviceion we opt for better UX at the risk of masking scheduling
